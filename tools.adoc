...
QPX tools provides a standardized set of commands to generate
...
[source,shell]
----
qpxc generate-pride-project-json
...
----
   ...
   --output_prefix_file   Prefix of the differential expression file (final name will be {prefix}-{uuid}.differential.tsv)
...
----
   --project_file   Descriptive information from project.json(project json path)
   --protein_file   Protein file that meets specific requirements(protein.txt)
   --output_prefix_file    Prefix of the absolute expression file (final name will be {prefix}-{uuid}.absolute.tsv)
   --delete_existing    Delete existing files in the output folder(default True)
----
...
[source,shell]
----
--mzml_file   Optional mzML file used to attach spectra by scan
--output_prefix_file   The prefix of the result file(like {prefix}-{uu.id}-{extension})
----
...
[source,shell]
----
qpxc plot plot-ibaq-distribution
...
[source,shell]
----
qpxc plot plot-kde-intensity-distribution
...
[source,shell]
----
qpxc plot plot-bar-peptide-distribution
--feature_path PXD010154-51b34353-227f-4d38-a181-6d42824de9f7.featrue.parquet
--num_samples 10
--save_path PXD014414_psm_peptides.svg
----
...
[source,shell]
----
qpxc plot plot-box-intensity-distribution
--feature_path PXD010154-51b34353-227f-4d38-a181-6d42824de9f7.featrue.parquet
--num_samples 10
--save_path PXD014414_psm_peptides.svg
----
