"""
Report generation module for quantms.io projects.

This module provides functionality to generate comprehensive statistical reports for quantms.io
...
class ProjectReportGenerator:
    """
    Generate comprehensive statistical reports for quantms.io projects.
    ...
    def generate_text_report(
        ...
        lines = []
        lines.append("=" * 80)
        lines.append("QUANTMS.IO PROJECT REPORT")
        lines.append("=" * 80)
        lines.append("")
...
<head>
    ...
    <title>QuantMS.io Project Report</title>
    <style>
        body {{
...
<body>
    <div class="header">
        <h1>QuantMS.io Project Report</h1>
    ...
    <div class="footer">
        <p>Generated by QuantMS.io Report Generator</p>
        <p>For more information, visit <a href="https://github.com/bigbio/quantms.io">github.com/bigbio/quantms.io</a></p>
    </div>
</body>
</html>
        """
